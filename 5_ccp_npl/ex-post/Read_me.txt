...
py-files:
model_zucher.py: Functions related to the Zurcher model. The function includes the same element as NFXP, and in addition it includes functions called unc_state_transition, psi, phi and lambda
