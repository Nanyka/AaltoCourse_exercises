...
#!/usr/bin/env python3
import numpy as np
from tictactoe_play_utils import (FEATURE_NAMES, logits_for_state,
...
def newton_maximize(data, theta0, lam=1e-6, max_iter=70, tol=1e-6, armijo=1e-4, backtrack=0.5, verbose=True):
